...
namespace Shoper.Data.Migrations
{
    ...
    [Migration("20221203081940_mig_Initial1")]
            ...
            modelBuilder.Entity("Shoper.Entities.ProductImage", b =>
                {
                    ...
                    b.ToTable("PeoductImage", (string)null);
                });
            ...
            modelBuilder.Entity("Shoper.Entities.ProductPrice", b =>
                {
                    ...
                    b.Property<int?>("ProductPricePriceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductPricePriceId");
            ...
            modelBuilder.Entity("Shoper.Entities.ProductPrice", b =>
                {
                    ...
                    b.HasOne("Shoper.Entities.ProductPrice", null)
                        .WithMany("ProductPrices")
                        .HasForeignKey("ProductPricePriceId");
